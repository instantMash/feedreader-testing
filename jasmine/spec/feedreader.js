    ...
    describe("New Feed Selection", function() {
        ...
        beforeEach(function(done) {
            ...
            loadFeed(0, function() {
                ...
                loadFeed(1, function() { // We make the second loadFeed call from inside the callback of the first loadFeed call. That way, we know for sure that the first loadFeed call has finished.
                    newFeed = $('.feed').html();
                    done();
                }); // end second loadFeed call.
            }); // end first loadFeed call.
        }); // end beforeEach.
